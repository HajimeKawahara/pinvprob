...
If you want to perform the cross-validation (CV), provide the list of lambda. In this case, linear_model.RidgeCV is used to choose the lambda (but usually, smaller than I expect for the image retrieval).
